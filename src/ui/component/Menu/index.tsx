      ...
      <ul
...

        {
          categories.map((category)=>(
            <li key={category.key}>
              <button
              className="btn-square w-25 h-25 rounded-2xl text-lg cursor-pointer transition-colors
              bg-base-200 hover:bg-base-300 flex flex-col items-center justify-center"
